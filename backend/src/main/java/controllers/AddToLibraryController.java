...
public class AddToLibraryController {
    public String addToLibrary(String json){
        ...
        headers.add("Authorization", libraryData.getAuth());
        
        HttpEntity<String> reqEntity = new HttpEntity<String>("",headers);
        ResponseEntity<String> resEntity = new RestTemplate().exchange("https://api.spotify.com/v1/me/tracks?ids=" + libraryData.getTrack_id()
